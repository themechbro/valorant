...
const socials = [
  ...
  { icon: <YouTubeIcon />, link: "https://www.youtube.com/@Valorant" },
  { icon: <InstagramIcon />, link: "https://instagram.com/valorant" },
  { icon: <FacebookIcon />, link: "https://www.facebook.com/playvalorant/" },
  { icon: <GitHubIcon />, link: "https://github.com/themechbro" },
];
const links = [
  "privacy notice",
...
const ratingimg = [
  "https://images.contentstack.io/v3/assets/blt0eb2a2986b796d29/blt45fdb1ce76c77293/5e7a5d8ccd562e2d656ccc57/EU_-_16_black.jpg?&height=100&disable=upscale",
  "https://images.contentstack.io/v3/assets/blt0eb2a2986b796d29/blt65b392ad6fcc1870/5e7d3ccfd84c6d2d6707a600/EU_-_descriptor_violence.png?&height=100&disable=upscale",
  "https://images.contentstack.io/v3/assets/blt0eb2a2986b796d29/blta4cd2560c7208614/5e7d3cf671abc60ae32d3960/EU_-_descriptor_in-game-purchase.png?&height=100&disable=upscale",
];
  ...
  return (
    <footer className="footer p-5">
      <div className="container footer_container">
        <div className="icons d-flex flex-column flex-md-row justify-content-evenly w-md-50 w-25">
          {socials.map((i) => {
            return (
              <IconButton variant="soft">
                <Link href={i.link} color="none">
                  {i.icon}
                </Link>
              </IconButton>
            );
        ...
        <div className="logos mt-5 d-flex flex-column flex-md-row justify-content-evenly align-items-center w-md-50 w-25 ">
          <svg
            width="99"
            fill="grey"
            height="32"
        ...
        <div className="copyright w-50 mt-5 p-3">
          <Typography
            level="body-md"
            sx={{ color: "#FFF", textAlign: "center" }}
          >
            © 2020-2024 Riot Games, Inc. All rights reserved. The contents in
            this website is taken from Riot Games Valorant page. This Page is
            purely made for educational purpose. Made by Adrin
          </Typography>
        </div>
        <div className="links mt-5 d-flex flex-column flex-md-row justify-content-evenly align-items-center w-75  ">
          {links.map((m) => {
            return (
              <Button
                variant="soft"
        ...
        <div className="ratings mt-5 d-flex flex-column flex-md-row justify-content-evenly align-items-center w-50 ">
          {ratingimg.map((j) => {
            return (
